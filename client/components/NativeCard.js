      ...
      <>
        <Content padder scrollEnabled={false} style={{flex: 0, borderRadius: 15}}>
          <Card style={{flex: 0, borderRadius: 15}}>
            <CardItem header bordered style={{ backgroundColor: "thistle", borderBottom: 20, borderTopLeftRadius: 15, borderTopRightRadius: 15, paddingLeft: 0, paddingRight: 0, paddingTop: 0, paddingBottom: 5 }}>
