...
import MyStripeCheckout from '../components/MyStripeCheckout';
  ...
  return (
    <>
      ...
      <ScrollView style={styles.container}>
        ...
        <Text style={{ marginTop: 15 }}>BuyCredits:{description}</Text>
        <TextInput
          style={styles.textBoxes}
          onChangeText={(text) => setDescription(text)}
        />
        <MyStripeCheckout STRIPE_PUBLISHABLE={STRIPE_PUBLISHABLE} CHECKOUT_SESSION_ID={CHECKOUT_SESSION_ID}/>
